...
#define A_MOD     CTL_T(KC_A)
#define SCLN_MOD  CTL_T(KC_SCLN)
#define Z_MOD     SFT_T(KC_Z)
#define SLSH_MOD  RSFT_T(KC_SLSH)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN] = LAYOUT_split_3x5_3(
        ...
        A_MOD,  KC_S,  KC_D,  KC_F,     KC_G,                        KC_H,      KC_J,  KC_K,     KC_L,    SCLN_MOD,
        Z_MOD,  KC_X,  KC_C,  KC_V,     KC_B,                        KC_N,      KC_M,  KC_COMM,  KC_DOT,  SLSH_MOD,
                              ESC_NUM,  SPC_SYM,  KC_TAB,  KC_ENT,   BSPC_NAV,  ALT
    ),
    [_SYM] = LAYOUT_split_3x5_3(
        ...
        KC_TRNS,   KC_PLUS,   KC_GRV,    KC_QUOTE,   S(KC_QUOT),                       KC_EQL,    KC_PLUS,   KC_MINS,   KC_SLSH,   KC_TRNS,
