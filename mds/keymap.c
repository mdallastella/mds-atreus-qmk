...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QW] = LAYOUT(KC_Q,                             KC_W,     KC_E,     KC_R,     KC_T,                                  KC_Y,     KC_U,             KC_I,             KC_O,     KC_P,
                   ...
                   KC_Z,                             KC_X,     KC_C,     KC_V,     KC_B,     KC_GRV,  TD(TD_BSLS_EMACS),  KC_N,     KC_M,             KC_COMM,          KC_DOT,   KC_SLSH,
                   MT(MOD_LCTL | MOD_LALT, KC_ESC),  KC_LCTL,  KC_LGUI,  MO(_L2),  KC_LSFT,  KC_SPC,  KC_BSPC,            MO(_L1),  LALT_T(KC_RALT),  KC_MINS,          KC_QUOT,  KC_ENT),
