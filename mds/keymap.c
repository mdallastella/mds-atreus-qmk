...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QW] = LAYOUT(KC_Q,    KC_W,      KC_E,          KC_R,           KC_T,                               KC_Y,     KC_U,          KC_I,          KC_O,     KC_P,
                   KC_A,    KC_S,      LALT_T(KC_D),  LCTL_T(KC_F),   KC_G,                               KC_H,     RCTL_T(KC_J),  LALT_T(KC_K),  KC_L,     KC_SCLN,
                   KC_Z,    KC_X,      KC_C,          KC_V,           KC_B,           KC_GRV,  KC_BSLS,   KC_N,     KC_M,          KC_COMM,       KC_DOT,   KC_SLSH,
                   KC_ESC,  KC_LCTL,   KC_LGUI,       MO(_L2),        KC_LSFT,        KC_SPC,  KC_BSPC,   MO(_L1),  KC_RALT,       KC_MINS,       KC_QUOT,  KC_ENT),
